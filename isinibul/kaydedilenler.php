		...
		<div class="row ml-5 " >
			...
			<div class="col-9 ml-2" 	>
				<div class="row mt-3 mb-3">
					<div class="col">
						<p class="ml-1" style="margin: 0;font-size: 20px; font-size: 1.125rem; font-family: Roboto-Medium,-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,Noto Sans,sans-serif;color: #333;">Kaydedilenler</p>
					</div>
				...
				$query = "SELECT * FROM kaydedilenler  WHERE uyeid= " .$id;
				if ($result=mysqli_query($baglanti , $query)) {
					while ( $row = mysqli_fetch_assoc($result)) {
						...
						<div class="row ml-2 mr-2" style="border : 1px solid #E0E0E0">
							<div class="col">
								...
								<a class="float-right ml-3 text-info" href="kaydedilenilansil.php?ilanid=<?php echo $rowilan["id"]?>">Sil</a>	
					...
					if (empty($rowilan["id"])) {
						...
						<div class="row mt-3 mb-3">
							<div class="col">
								<p class="ml-5 mt-5" style="margin: 0;font-size: 15px; font-size: 1.125rem; font-family: Roboto-Medium,-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,Noto Sans,sans-serif;color: #333;">Kaydettiğin Bir İlan Yok</p>
							</div>
