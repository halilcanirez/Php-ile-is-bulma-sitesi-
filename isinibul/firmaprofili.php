...
$query = "SELECT * FROM isverenkullanıcılar WHERE id= ".$sirketid;
...
<body>
	...
	<div class="container">
		...
		<div class="row mt-2">
			...
			<div class="col-10">
				<h5 class="" style="color: #333;font-size: 10px;  font-size: 1.5rem;"><?php echo $row["sirketismi"] ?> İş İlanları
</h5>
			</div>
			<div class="col-1"></div>
		</div>
		<br>
		<?php 
				$query = "SELECT * FROM isilanları WHERE sirketid= ".$row["id"];
				...
				<div class="row mt-2" style="border : 1px solid #E0E0E0">
					<div class="col">
						...
						<a style="    font-size: 18px; color: #333; margin-bottom: 0; " href="isilanıgöster.php?ID=<?php echo $row["id"]?>"> <?php echo $row["isinismi"]; ?></a>	

						

						<a style="font-size: 16px; color: #333; margin-bottom: 0; "  href="firmaprofili.php?ID=<?php echo $row["sirketid"]?>"><p><?php echo $row["sirketismi"] ; ?></p> </a> 
