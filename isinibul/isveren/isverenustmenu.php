	...
	<div class="container-fluid">
		<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 bg-white border-bottom shadow-sm">
			...
			if (empty($_SESSION["isveren"])) {
				...
				<a class="btn btn-info  mr-2" href="isverengirisi.php">İşveren</a>
				<a class="btn btn-secondary mr-5" href="#">İş İlanı Yayınla</a>
				<?php 
			} 
			else{
				?>
				<a class="btn btn-info mr-2" href="profil.php">Hesabım</a>
				<a class="btn btn-info mr-2" href="ilanolustur.php">İş İlanı Yayınla</a>
				<a class="btn btn-info mr-2" href="ilanlar.php">İlanlar </a>
				<a class="btn btn-info mr-2 " href="sifredegistir.php">Ayarlar</a>
