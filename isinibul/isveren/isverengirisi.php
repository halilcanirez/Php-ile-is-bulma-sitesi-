...
if (isset($_POST["girisyap"])) {
	if ( $_POST["email"] != ""  && $_POST["sifre"] != "" ) {
		...
		$query = "SELECT * FROM isverenkullanıcılar WHERE email LIKE '%$email%' ";
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="row">
					<div class="col-10">
						<p> İşiniBul.com'da İşveren Hesabın Yok mu?</p>
						<p class="text-center"><a href="isverenbasvuru.php" class="text-info">Hemen Hesap Oluştur</a></p>
						<br>
